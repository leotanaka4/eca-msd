...
a energia cinética rotacional pode ser aproximada, porque para ângulos pequenos $\dot{\theta}_r \dot{\theta}_l \approx 0$ para ângulos pequenos e $J_m$ é desprezível. Logo:
...
\begin{gathered}
    ...
    = \frac{J_{\phi}\dot{\phi}^2}{2} + \frac{J_{\psi}\dot{\psi}^2}{2} + J_w(2\dot{\theta}^2 - \dot{\theta}_l\dot{\theta}_r) + ? = \\
...
Esta dinâmica pode ser escrita em forma matricial como:
\begin{equation}
